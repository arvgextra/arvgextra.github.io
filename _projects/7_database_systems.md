...
**Redis vs MySQL — Twitter-like API** ([twitter_rdb](https://github.com/arvgextra/twitter_rdb) · [graph-data-models](https://github.com/arvgextra/graph-data-models))
...
**EV Dataset — MongoDB + Geospatial Indexing** ([ev_mongo](https://github.com/arvgextra/ev_mongo))
